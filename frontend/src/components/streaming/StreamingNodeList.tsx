...
const NodeStreamingCard: React.FC<NodeStreamingCardProps> = ({
  ...
  const colorSchemes = [
    ...
    },
    {
      ...
      border: "border-l border-[hsl(var(--secondary))]",
    },
    {
      gradient:
        ...
        <div className="grid grid-cols-3 gap-2">
          {node.services.map((service) => {
            ...
            return (
              <div
                key={service.service}
                className="flex flex-col items-center justify-between gap-1 rounded-lg border border-border surface-elevated px-2 py-2 min-h-[88px]"
              >
