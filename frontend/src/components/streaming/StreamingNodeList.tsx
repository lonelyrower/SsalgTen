        ...
        <div className="grid grid-cols-3 gap-2">
          {node.services.map((service) => {
            ...
            return (
              <div
                key={service.service}
                className="flex flex-col items-center justify-between gap-1  border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-900/50 px-2 py-2 min-h-[88px]"
              >
