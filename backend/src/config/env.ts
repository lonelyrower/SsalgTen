...
export const loadEnvConfig = (): EnvConfig => {
  const config: EnvConfig = {
    ...
    POSTGRES_USER: parseString(process.env.POSTGRES_USER, defaultConfig.POSTGRES_USER!),
    POSTGRES_PASSWORD: parseString(process.env.POSTGRES_PASSWORD, defaultConfig.POSTGRES_PASSWORD!),
    POSTGRES_DB: parseString(process.env.POSTGRES_DB, defaultConfig.POSTGRES_DB!),
    POSTGRES_HOST: parseString(process.env.POSTGRES_HOST, defaultConfig.POSTGRES_HOST!),
    POSTGRES_PORT: parseNumber(process.env.POSTGRES_PORT, defaultConfig.POSTGRES_PORT!),
    ...
    JWT_EXPIRES_IN: parseString(process.env.JWT_EXPIRES_IN, defaultConfig.JWT_EXPIRES_IN!),
    REFRESH_TOKEN_EXPIRES_IN: parseString(process.env.REFRESH_TOKEN_EXPIRES_IN, defaultConfig.REFRESH_TOKEN_EXPIRES_IN!),
    
    API_KEY_SECRET: parseString(process.env.API_KEY_SECRET, ''),
    DEFAULT_AGENT_API_KEY: parseString(process.env.DEFAULT_AGENT_API_KEY, ''),
    
    CORS_ORIGIN: parseString(process.env.CORS_ORIGIN, defaultConfig.CORS_ORIGIN!),
    
    AGENT_HEARTBEAT_INTERVAL: parseNumber(process.env.AGENT_HEARTBEAT_INTERVAL, defaultConfig.AGENT_HEARTBEAT_INTERVAL!),
    AGENT_TIMEOUT: parseNumber(process.env.AGENT_TIMEOUT, defaultConfig.AGENT_TIMEOUT!),
    AGENT_OFFLINE_THRESHOLD: parseNumber(process.env.AGENT_OFFLINE_THRESHOLD, defaultConfig.AGENT_OFFLINE_THRESHOLD!),
    AGENT_REQUIRE_SIGNATURE: parseBoolean(process.env.AGENT_REQUIRE_SIGNATURE, defaultConfig.AGENT_REQUIRE_SIGNATURE!),
    ...
    ENABLE_MORGAN: parseBoolean(process.env.ENABLE_MORGAN, defaultConfig.ENABLE_MORGAN!),
    
    DEFAULT_PING_COUNT: parseNumber(process.env.DEFAULT_PING_COUNT, defaultConfig.DEFAULT_PING_COUNT!),
    DEFAULT_TRACEROUTE_MAX_HOPS: parseNumber(process.env.DEFAULT_TRACEROUTE_MAX_HOPS, defaultConfig.DEFAULT_TRACEROUTE_MAX_HOPS!),
    MTR_COUNT: parseNumber(process.env.MTR_COUNT, defaultConfig.MTR_COUNT!),
    SPEEDTEST_SERVER_ID: parseString(process.env.SPEEDTEST_SERVER_ID, defaultConfig.SPEEDTEST_SERVER_ID!),
    
    TRUST_PROXY: parseBoolean(process.env.TRUST_PROXY, defaultConfig.TRUST_PROXY!),
    ENABLE_SYSTEM_METRICS: parseBoolean(process.env.ENABLE_SYSTEM_METRICS, defaultConfig.ENABLE_SYSTEM_METRICS!),
    HEALTH_CHECK_INTERVAL: parseNumber(process.env.HEALTH_CHECK_INTERVAL, defaultConfig.HEALTH_CHECK_INTERVAL!),
    
    SOCKET_PING_TIMEOUT: parseNumber(process.env.SOCKET_PING_TIMEOUT, defaultConfig.SOCKET_PING_TIMEOUT!),
    SOCKET_PING_INTERVAL: parseNumber(process.env.SOCKET_PING_INTERVAL, defaultConfig.SOCKET_PING_INTERVAL!),
