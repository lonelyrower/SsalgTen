...
router.get(
  "/system/version",
  publicLimiter,
  updateController.getVersion.bind(updateController),
);
router.post(
  "/admin/system/update",
  authenticateToken,
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  updateController.getUpdateLog.bind(updateController),
);
router.get(
  "/admin/system/updater/health",
  authenticateToken,
  requireAdmin,
...
router.put(
  ...
  authenticateToken,
  requireAdmin,
  nodeController.updateNode.bind(nodeController),
);
router.delete(
  "/nodes/:id",
  authenticateToken,
...
router.get(
  "/diagnostics/:id/ping",
  authenticateToken,
  diagnosticsProxyController.ping.bind(diagnosticsProxyController),
);
router.get(
  "/diagnostics/:id/traceroute",
  authenticateToken,
  diagnosticsProxyController.traceroute.bind(diagnosticsProxyController),
);
router.get(
  "/diagnostics/:id/mtr",
  authenticateToken,
  diagnosticsProxyController.mtr.bind(diagnosticsProxyController),
);
router.get(
  "/diagnostics/:id/speedtest",
  authenticateToken,
  diagnosticsProxyController.speedtest.bind(diagnosticsProxyController),
);
router.get(
  "/diagnostics/:id/latency-test",
  authenticateToken,
  diagnosticsProxyController.latencyTest.bind(diagnosticsProxyController),
);
...
router.post(
  ...
  nodeController.registerAgent.bind(nodeController),
);
router.post(
  "/agents/:agentId/heartbeat",
  agentLimiter,
  validateBody(AgentHeartbeatSchema),
  nodeController.heartbeat.bind(nodeController),
);
router.post(
  "/agents/:agentId/diagnostic",
  agentLimiter,
  validateBody(AgentDiagnosticSchema),
  nodeController.reportDiagnostic.bind(nodeController),
);
// 安装脚本/命令仅管理员可获取
router.get(
  ...
  authenticateToken,
  requireAdmin,
  nodeController.getInstallScript.bind(nodeController),
);
router.get(
...
router.post(
  ...
  adminController.createNode.bind(adminController),
);
router.put(
  "/admin/nodes/:id",
  authenticateToken,
  ...
  adminController.updateNode.bind(adminController),
);
router.get(
  "/admin/nodes/:id/api-key",
  authenticateToken,
  requireAdmin,
  adminController.viewNodeApiKey.bind(adminController),
);
router.delete(
  "/admin/nodes/:id",
  authenticateToken,
  requireAdmin,
  adminController.deleteNode.bind(adminController),
);
// 批量导入占位节点（资产）
router.post(
  ...
  authenticateToken,
  requireAdmin,
  adminController.importPlaceholderNodes.bind(adminController),
);
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  adminController.getSystemOverview.bind(adminController),
);
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  systemConfigController.getAllConfigs.bind(systemConfigController),
);
router.get(
  "/admin/configs/categories",
  authenticateToken,
  requireAdmin,
  systemConfigController.getCategories.bind(systemConfigController),
);
router.get(
  "/admin/configs/:key",
  authenticateToken,
  requireAdmin,
  systemConfigController.getConfig.bind(systemConfigController),
);
router.put(
  "/admin/configs/:key",
  authenticateToken,
...
router.post(
  ...
  authenticateToken,
  requireAdmin,
  systemConfigController.batchUpdateConfigs.bind(systemConfigController),
);
router.post(
  "/admin/configs/reset",
  authenticateToken,
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  nodeController.getApiKeyInfo.bind(nodeController),
);
router.post(
  "/admin/api-key/regenerate",
  authenticateToken,
  requireAdmin,
  nodeController.regenerateApiKey.bind(nodeController),
);
...
router.post(
  "/client-latency/test",
  authenticateToken,
  clientLatencyController.startLatencyTest.bind(clientLatencyController),
);
router.get(
